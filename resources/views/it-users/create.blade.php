...
@section('title', 'Crear Usuario - ITAM System')
...
<div class="bg-white rounded-lg shadow">
    <form method="POST" action="{{ route('it-users.store') }}" class="p-6">
        @csrf
        ...
        <div class="mt-8 flex justify-end space-x-4">
            <a href="{{ route('it-users.index') }}" class="bg-gray-300 text-gray-700 px-6 py-2 rounded-md hover:bg-gray-400">
                Cancelar
            </a>
